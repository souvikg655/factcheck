...
<body>
	...
	<header id="header" class="site-header">
		<div class="logo">
			<a href="<?php echo base_url()?>user/dashboard" title=""><img src="<?php echo base_url()?>assets/images/logo.png" alt=""></a>
		</div>
			...
			<div class="dropdown user-profile">
				...
				<div class="clickslide">
					<ul>
						...
						<li><a href="javascript:void(0);" title="">log out</a></li>
					</ul>
				</div>
			</div>
	...
	<div class="main-content">
		<div class="left-aside">
			<nav>
				<ul>
					<li class="list"><a href="<?php echo base_url()?>user/dashboard" title="">list</a></li>
					<li class="add active"><a href="<?php echo base_url()?>user/add_home" title="">add new</a></li>
					<!-- <li class="profile-settings"><a href="javascript:void(0);" title="">Profile</a></li> -->
				</ul>
			</nav>
		</div>